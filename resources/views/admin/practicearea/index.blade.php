@section('title' , 'practicearea -- Listing' )
     ...
     <div class="card mb-4">
       <div class="card-header py-3">
        ...
        <div class="d-flex justify-content-end" >
          <a href="{{ route('practiceArea.create') }}" class="btn btn-primary"><i class="fas fa-pen"></i> Add practicearea</a>   
        </div>   
        @endif 
       ...
       <div class="table-responsive p-3">
         <table class="table align-items-center table-flush table-hover mb-5" id="dataTableHover" >
           ...
           <tbody>  
               @foreach ($entries as $key=>$practicearea)
                   <tr>
                      <td>{{ $key+1 }}</td>     
                      <td>
                        {{ $practicearea->practice_head  }} 
                      </td>
                      {{-- <td>
                        {{ $practicearea->practicearea_heading  }} 
                      </td> --}}
                       <td>
                         <img src="{{ asset('public/'. $practicearea->practice_image) }}" alt="image_not_loaded" width="65">
                        </td>
                        <td>
                      ...
                      <td>
                        <a href="{{ route('practiceArea.edit' , $practicearea->id) }}" class="btn btn-primary btn-icon-split btn-sm">
                         ...
                         <div class="modal-dialog" role="document">
                           <div class="modal-content">
                             ...
                             <div class="modal-body">
                                 ...
                                 This Will Delete the testimonial Permanently , <br> <br> The testimonial Is <br> {{$practicearea->practice_head}}
                             </div>
                             <div class="modal-footer">
                               ...
                               <form action="{{ route('practiceArea.destroy' , $practicearea->id ) }}" method="post">
                                 @csrf
                                 @method('DELETE')
                      ...
                      <td>
                        {{ $practicearea->created_at->diffForHumans() }}
                      </td>
                  </tr>
               @endforeach
           </tbody>
       ...
       @else
            ...
            @include('includes.nodata', ['data' => "Sorry 0 practicearea Found" , 'route_name' => 'practicearea'])  
