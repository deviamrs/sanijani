     ...
     <div class="card mb-4">
       <div class="card-header py-3">
        ...
        <div class="d-flex justify-content-end" >
          <a href="{{ route('location.create') }}" class="btn btn-primary"><i class="fas fa-pen"></i> Add location</a>   
        </div>   
        @endif 
               ...
               @foreach ($locations as $key=>$location)
                   <tr>
                      ...
                      <td>
                       ...
                       <td>
                         <img src="{{ asset('public/'. $location->location_front_image) }}" alt="image_not_loaded" width="65">
                        </td>
                        {{-- <td>

                          <a class="btn btn-sm btn-info " href="{{ route('locationsection.index' , $location->id ) }}">{{ $location->locationsections->count() }}</a>
                          <a href="{{ route('locationsection.create' , $location->id ) }}" class="btn btn-primary btn-icon-split btn-sm">
                      ...
                      <td>
                        <a href="{{ route('location.edit' , $location->id) }}" class="btn btn-primary btn-icon-split btn-sm">
                           <span class="icon text-white-50">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  This Will Delete the location Permanently , <br> <br> The location Is <br> {{$location->location_main_head}}
                              </div>
       ...
       @else
            ...
            @include('includes.nodata', ['data' => "Sorry 0 location Found" , 'route_name' => 'location'])  
