     ...
     <div class="card mb-4">
       <div class="card-header py-3">
        ...
        <div class="d-flex justify-content-end" >
          <a href="{{ route('service.create') }}" class="btn btn-primary"><i class="fas fa-pen"></i> Add service</a>   
        </div>   
        @endif 
               ...
               @foreach ($services as $key=>$service)
                   <tr>
                      ...
                      <td>
                       ...
                       <td>
                         <img src="{{ asset('public/'. $service->service_front_image) }}" alt="image_not_loaded" width="65">
                        </td>
                        {{-- <td>

                          <a class="btn btn-sm btn-info " href="{{ route('servicesection.index' , $service->id ) }}">{{ $service->servicesections->count() }}</a>
                          <a href="{{ route('servicesection.create' , $service->id ) }}" class="btn btn-primary btn-icon-split btn-sm">
                      ...
                      <td>
                        <a href="{{ route('service.edit' , $service->id) }}" class="btn btn-primary btn-icon-split btn-sm">
                           <span class="icon text-white-50">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  This Will Delete the service Permanently , <br> <br> The service Is <br> {{$service->service_main_head}}
                              </div>
       ...
       @else
            ...
            @include('includes.nodata', ['data' => "Sorry 0 service Found" , 'route_name' => 'service'])  
